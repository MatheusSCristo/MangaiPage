...
const contatoForm = () => {
  ...
  return (
    <div className='flex flex-col h-max-content w-max-content px-16'>
            <h1 className='text-[2em]'>Deseja reservar o ambiente <br /> para comemorações privativas?
            </h1>
            <h2 className='mt-4'>Deixe seus dados e entraremos em <br /> contato assim que possível.</h2>

            <form className='flex flex-col w-3/5 h-full' onSubmit={handleSubmit()}>
